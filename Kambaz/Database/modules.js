export default [
    ...
    lessons: [
      {
        ...
        description:
          "Fundamental concepts of aerodynamics and their applications.",
        module: "M201",
      },
      {
        _id: "L102",
        ...
        description:
          "Exploration of fluid dynamics principles relevant to aerodynamics.",
        module: "M201",
      },
      {
        _id: "L103",
        name: "Airflow Analysis",
        description: "Techniques for analyzing airflow over surfaces.",
        module: "M201",
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        description: "Detailed look at characteristics of subsonic flows.",
        module: "M202",
      },
      {
        _id: "L202",
        name: "Transition to Supersonic Flow",
        description:
          "Study of transition phenomena between subsonic and supersonic speeds.",
        module: "M202",
      },
      {
        _id: "L203",
        name: "Supersonic Flow Challenges",
        description:
          "Examination of challenges and design considerations in supersonic flow.",
        module: "M202",
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        description: "Basic principles of heating in aerodynamic environments.",
        module: "M203",
      },
      {
        _id: "L302",
        ...
        description:
          "Methods and techniques for thermal analysis in high-speed flows.",
        module: "M203",
      },
      {
        _id: "L303",
        ...
        description:
          "Overview of systems used to protect structures from aerodynamic heating.",
        module: "M203",
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        description:
          "Fundamentals of spacecraft structure and design criteria.",
        module: "M301",
      },
      {
        _id: "L102",
        name: "Material Selection",
        description: "Overview of materials used in spacecraft construction.",
        module: "M301",
      },
      {
        _id: "L103",
        name: "Structural Analysis Techniques",
        description: "Methods for analyzing spacecraft structural integrity.",
        module: "M301",
      },
    ],
  },
  {
    ...
    lessons: [
      {
        _id: "L201",
        name: "Orbital Dynamics Basics",
        description: "Introduction to the principles of orbital mechanics.",
        module: "M302",
      },
      {
        _id: "L202",
        name: "Trajectory Planning",
        description: "Techniques for planning spacecraft trajectories.",
        module: "M302",
      },
      {
        _id: "L203",
        ...
        description:
          "Overview of common orbital maneuvers and their applications.",
        module: "M302",
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        description: "Fundamentals of integrating various spacecraft systems.",
        module: "M303",
      },
      {
        _id: "L302",
        ...
        description:
          "Detailed look at spacecraft subsystems and their functions.",
        module: "M303",
      },
      {
        _id: "L303",
        name: "Testing and Validation",
        description: "Processes for testing and validating spacecraft systems.",
        module: "M303",
      },
    ],
  },
